...
if (!$nutrition) {
    header("Location: beslenme-diyetetik.php");
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?php echo htmlspecialchars($nutrition['title']); ?> - Psikolog Merkezi</title>
    <meta name="description" content="<?php echo htmlspecialchars(substr(strip_tags($nutrition['content']), 0, 160)); ?>">
        ...
        <div class="container">
            <div class="blog-detail-container">
                <div class="blog-detail-header">
                    <h1><?php echo htmlspecialchars($nutrition['title']); ?></h1>
                    <div class="blog-meta">
                        <span class="blog-date"><?php echo date('d.m.Y', strtotime($nutrition['created_at'])); ?></span>
                    </div>
                </div>
                <?php if ($nutrition['image_path']): ?>
                <div class="blog-detail-image">
                    <img src="uploads/<?php echo htmlspecialchars($nutrition['image_path']); ?>" alt="<?php echo htmlspecialchars($nutrition['title']); ?>">
                </div>
                <?php endif; ?>
                <div class="blog-detail-content">
                    <?php echo $nutrition['content']; ?>
                </div>
                <div class="blog-detail-footer">
                    <a href="beslenme-diyetetik.php" class="btn btn-secondary">← Beslenme & Diyetetik'e Dön</a>
                </div>
            </div>
        </div>
    </section>
