...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!validateCSRFToken($_POST['csrf_token'])) {
        ...
        if (empty($errors)) {
            try {
                $stmt = $pdo->prepare("UPDATE blog SET title = ?, content = ?, image_path = ? WHERE id = ?");
...
<head>
    ...
    <title>Blog Yazısı Düzenle - Admin Panel</title>
    ...
    <div class="admin-container">
        <div class="container">
            ...
            <div class="admin-nav">
                ...
                <a href="blog-yonetimi.php" style="font-weight:700; color:var(--primary-purple);">📝 Blog Yönetimi</a>
            ...
            <?php endif; ?>
            <div class="card">
                <h2 style="color: var(--white); font-size: 1.8rem; font-weight: 700; margin-bottom: 2rem; text-align: center;">📝 Blog Yazısı Düzenle</h2>
                <form method="POST" action="blog-duzenle.php?id=<?php echo $id; ?>" enctype="multipart/form-data" id="blog-form">
                    ...
                    <div class="form-group">
                        ...
                        <div id="image-preview">
                            <?php if ($blog['image_path']): ?>
                                <img src="../uploads/<?php echo htmlspecialchars($blog['image_path']); ?>" class="preview-image" alt="Önizleme">
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="content">📝 İçerik *</label>
                        <textarea id="content" name="content" class="form-control" required><?php echo htmlspecialchars($blog['content']); ?></textarea>
                    </div>
