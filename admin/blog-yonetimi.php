...
<head>
    ...
    <title>Blog Yönetimi - Psikolog Merkezi</title>
    ...
    <div class="admin-container">
        <div class="container">
            ...
            <div class="admin-page-header" style="display:flex; justify-content:space-between; align-items:center; margin-bottom:2rem;">
                <h1 class="admin-page-title">Blog Yönetimi</h1>
                <a href="blog-ekle.php" class="btn">+ Yeni Blog Yazısı</a>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="blog-duzenle.php?id=<?php echo $blog['id']; ?>" class="action-btn btn-detail">Düzenle</a>
                                    <button onclick="deleteBlog(<?php echo $blog['id']; ?>)" class="action-btn btn-reject">Sil</button>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
