...
$stmt = $pdo->prepare("SELECT * FROM blog ORDER BY created_at DESC LIMIT :limit OFFSET :offset");
...
<head>
    ...
    <title>Blog - Psikolog Merkezi</title>
    <meta name="description" content="Psikoloji ve ruh sağlığı hakkında uzman blog yazıları. Stres yönetimi, anksiyete, depresyon ve daha fazlası.">
...
<body>
    ...
    <section class="hero hero-modern">
        <div class="container hero-content" style="display: flex; justify-content: center; align-items: center;">
            <div class="hero-text">
                <h1>Blog</h1>
                <p>Psikoloji ve ruh sağlığı hakkında uzman görüşlerimizi paylaştığımız blog yazılarımızı okuyabilirsiniz</p>
            </div>
        </div>
    </section>
    <!-- Blog İçerik -->
        ...
        <div class="container">
            ...
            <div class="about-content">
                <div class="about-text">
                    ...
                    <p>Yakında psikoloji ve ruh sağlığı hakkında uzman görüşlerimizi paylaştığımız blog yazılarımız yayınlanacak. Stres yönetimi, anksiyete, depresyon, ilişki problemleri ve daha birçok konuda faydalı içerikler sunacağız.</p>
                    <p>Blog yazılarımızdan haberdar olmak için sosyal medya hesaplarımızı takip edebilir veya bültenimize abone olabilirsiniz.</p>
                </div>
            </div>
            <?php else: ?>
            ...
            <div class="text-center" style="margin-top: 3rem;">
                ...
                <p style="margin-top: 1rem; color: #4A5568; font-size: 0.9rem;">
                    ...
                    (Toplam <?php echo $total_blogs; ?> yazı)
                </p>
            </div>
            <?php endif; ?>
            <?php endif; ?>
